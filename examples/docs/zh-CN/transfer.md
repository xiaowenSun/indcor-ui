...
```html
<template>
  <gpzx-transfer v-model="value" :data="data"></gpzx-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <gpzx-transfer
      ...
      @change="handleChange"
      :data="data">
      <gpzx-button class="transfer-footer" slot="left-footer" size="small">操作</gpzx-button>
      <gpzx-button class="transfer-footer" slot="right-footer" size="small">操作</gpzx-button>
    </gpzx-transfer>
  </div>
