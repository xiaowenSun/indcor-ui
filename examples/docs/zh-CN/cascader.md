...
<div class="block">
  ...
  <gpzx-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></gpzx-cascader>
</div>
<div class="block">
...
```html
<gpzx-cascader :options="options"></gpzx-cascader>
...
:::demo
```html
<gpzx-cascader :options="options" clearable></gpzx-cascader>
...
```html
<gpzx-cascader :options="options" :show-all-levels="false"></gpzx-cascader>
...
```html
<gpzx-cascader :props="props"></gpzx-cascader>
...
```html
<gpzx-cascader-panel :options="options"></gpzx-cascader-panel>
