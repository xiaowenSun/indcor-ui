...
:::demo
```html
<gpzx-input v-model="input" placeholder="请输入内容"></gpzx-input>
...
```html
<gpzx-input placeholder="请输入密码" v-model="input" show-password></gpzx-input>
...
```html
<div>
  <gpzx-input placeholder="请输入内容" v-model="input1">
    <template slot="prepend">Http://</template>
  </gpzx-input>
</div>
<div style="margin-top: 15px;">
  <gpzx-input placeholder="请输入内容" v-model="input2">
    <template slot="append">.com</template>
  </gpzx-input>
</div>
<div style="margin-top: 15px;">
  <gpzx-input placeholder="请输入内容" v-model="input3" class="input-with-select">
    <gpzx-select v-model="select" slot="prepend" placeholder="请选择">
      <gpzx-option label="餐厅名" value="1"></gpzx-option>
...
<style>
  .gpzx-select .gpzx-input {
    width: 130px;
  }
  .input-with-select .gpzx-input-group__prepend {
...
```html
<gpzx-row class="demo-autocomplete">
  <gpzx-col :span="12">
