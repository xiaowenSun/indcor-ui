...
<template>
  <div class="component-preview">
    ...
    <gpzx-row class="demo-line">
      ...
      <gpzx-button type="primary">Primary</gpzx-button>
      <gpzx-button type="success">Success</gpzx-button>
      <gpzx-button type="info">Info</gpzx-button>
      <gpzx-button type="warning">Warning</gpzx-button>
      <gpzx-button type="danger">Danger</gpzx-button>
    </gpzx-row>
    <gpzx-row class="demo-line">
      <gpzx-button plain>Plain</gpzx-button>
      <gpzx-button type="primary" plain>Primary</gpzx-button>
      <gpzx-button type="success" plain>Success</gpzx-button>
      <gpzx-button type="info" plain>Info</gpzx-button>
      <gpzx-button type="warning" plain>Warning</gpzx-button>
      <gpzx-button type="danger" plain>Danger</gpzx-button>
    </gpzx-row>
    <gpzx-row class="demo-line">
      <gpzx-button round>Round</gpzx-button>
      <gpzx-button type="primary" round>Primary</gpzx-button>
      <gpzx-button type="success" round>Success</gpzx-button>
      <gpzx-button type="info" round>Info</gpzx-button>
      <gpzx-button type="warning" round>Warning</gpzx-button>
    ...
    <gpzx-row class="demo-line">
      <gpzx-button>Default</gpzx-button>
      <gpzx-button size="medium">Medium</gpzx-button>
      <gpzx-button size="small">Small</gpzx-button>
      <gpzx-button size="mini">Mini</gpzx-button>
    </gpzx-row>
    <h4>Radio</h4>
    <gpzx-row class="demo-line">
    ...
    <gpzx-row>
      <el-transfer v-model="transfer" filterable :data="transferData">
        <gpzx-button class="transfer-footer" slot="left-footer" size="small">Operation</gpzx-button>
        <gpzx-button class="transfer-footer" slot="right-footer" size="small">Operation</gpzx-button>
      </el-transfer>
    </gpzx-row>
    <h4>Table</h4>
    <gpzx-row>
    ...
    <gpzx-row>
      <el-badge :value="12" class="demo-item">
        <gpzx-button size="small">comments</gpzx-button>
      </el-badge>
      <el-badge :value="3" class="demo-item">
        <gpzx-button size="small">replies</gpzx-button>
      </el-badge>
