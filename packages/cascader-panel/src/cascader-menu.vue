...
export default {
  ...
  methods: {
    ...
    renderEmptyText(h) {
      return (
        <div class="gpzx-cascader-menu__empty-text">{ this.t('el.cascader.noData') }</div>
      );
    },
    renderNodeList(h) {
      const { menuId } = this;
      ...
      return [
        ...nodes,
        isHoverMenu ? <svg ref='hoverZone' class='gpzx-cascader-menu__hover-zone'></svg> : null
      ];
    }
  },
  ...
  render(h) {
    ...
    return (
      <gpzx-scrollbar
        ...
        role="menu"
        id={ menuId }
        class="gpzx-cascader-menu"
        wrap-class="gpzx-cascader-menu__wrap"
        view-class={{
          'gpzx-cascader-menu__list': true,
          'is-empty': isEmpty
        }}
        { ...events }>
