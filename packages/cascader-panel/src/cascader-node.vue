<script>
  ...
  import GpzxRadio from 'gpzx-ui/packages/radio';
  import { isEqual } from 'gpzx-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderContent(h) {
        ...
        return (
          <span class="gpzx-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
