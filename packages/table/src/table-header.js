import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'gpzx-ui/src/utils/dom';
...
export default {
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.gpzx-table__column-filter-trigger') || cell;
