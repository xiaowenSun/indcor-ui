  ...
  <div
    ...
    <span
      ...
      <i
        ...
        class="gpzx-rate__icon"
        :style="getIconStyle(item)">
        <i
          v-if="showDecimalIcon(item)"
          :class="decimalIconClass"
          :style="decimalStyle"
          class="gpzx-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="gpzx-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>

<script>
  import { hasClass } from 'gpzx-ui/src/utils/dom';
  import { isObject } from 'gpzx-ui/src/utils/types';
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'gpzx-rate__item')) {
            target = target.querySelector('.gpzx-rate__icon');
          }
          if (hasClass(target, 'gpzx-rate__decimal')) {
