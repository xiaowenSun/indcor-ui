      ...
      <div class="gpzx-picker-panel__body-wrapper">
        ...
        <div class="gpzx-picker-panel__body">
          <div class="gpzx-date-range-picker__time-header" v-if="showTime">
            ...
            <span class="gpzx-icon-arrow-right"></span>
          ...
          <div class="gpzx-picker-panel__content gpzx-date-range-picker__content is-left">
            <div class="gpzx-date-range-picker__header">
              ...
              <button
                type="button"
                @click="leftPrevMonth"
                class="gpzx-picker-panel__icon-btn gpzx-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="gpzx-picker-panel__icon-btn gpzx-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="gpzx-picker-panel__icon-btn gpzx-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
