<template>
  <transition name="gpzx-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="gpzx-picker-panel gpzx-date-range-picker gpzx-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="gpzx-picker-panel__body-wrapper">
        <slot name="sidebar" class="gpzx-picker-panel__sidebar"></slot>
        <div class="gpzx-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="gpzx-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="gpzx-picker-panel__body">
          <div class="gpzx-date-range-picker__time-header" v-if="showTime">
            <span class="gpzx-date-range-picker__editors-wrap">
              <span class="gpzx-date-range-picker__time-picker-wrap">
                <gpzx-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="gpzx-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="gpzx-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <gpzx-input
                  size="small"
                  class="gpzx-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="gpzx-date-range-picker__editors-wrap is-right">
              <span class="gpzx-date-range-picker__time-picker-wrap">
                <gpzx-input
                  size="small"
                  class="gpzx-date-range-picker__editor"
              ...
              <span class="gpzx-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <gpzx-input
                  size="small"
                  class="gpzx-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="gpzx-picker-panel__content gpzx-date-range-picker__content is-left">
            <div class="gpzx-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="gpzx-picker-panel__icon-btn gpzx-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="gpzx-picker-panel__icon-btn el-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="gpzx-picker-panel__icon-btn el-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="gpzx-picker-panel__icon-btn el-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="gpzx-picker-panel__content gpzx-date-range-picker__content is-right">
            <div class="gpzx-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
                ...
                :disabled="!enableYearArrow"
                :class="{ 'is-disabled': !enableYearArrow }"
                class="gpzx-picker-panel__icon-btn el-icon-d-arrow-left"></button>
              <button
                type="button"
      ...
      <div class="gpzx-picker-panel__footer" v-if="showTime">
        <gpzx-button
          size="mini"
          type="text"
          class="gpzx-picker-panel__link-btn"
          @click="handleClear">
...
<script type="text/babel">
  import {
    ...
    extractDateFormat,
    extractTimeFormat
  } from 'gpzx-ui/src/utils/date-util';
  import Clickoutside from 'gpzx-ui/src/utils/clickoutside';
  import Locale from 'gpzx-ui/src/mixins/locale';
  import TimePicker from './time';
  import DateTable from '../basic/date-table';
  import GpzxInput from 'gpzx-ui/packages/input';
  import GpzxButton from 'gpzx-ui/packages/button';
  ...
  export default {
    ...
    components: { TimePicker, DateTable, GpzxInput, GpzxButton }
  };
</script>
