<template>
  <transition
    name="gpzx-zoom-in-top"
    @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="gpzx-time-range-picker gpzx-picker-panel gpzx-popper"
      :class="popperClass">
      <div class="gpzx-time-range-picker__content">
        <div class="gpzx-time-range-picker__cell">
          <div class="gpzx-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="gpzx-time-range-picker__body gpzx-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="gpzx-time-range-picker__cell">
          <div class="gpzx-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="gpzx-time-range-picker__body gpzx-time-panel__content">
            <time-spinner
      ...
      <div class="gpzx-time-panel__footer">
        <button
          type="button"
          class="gpzx-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="gpzx-time-panel__btn confirm"
          @click="handleConfirm()"
