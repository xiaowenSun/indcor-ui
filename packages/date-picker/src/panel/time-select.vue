<template>
  <transition name="gpzx-zoom-in-top" @before-enter="handleMenuEnter" @after-leave="$emit('dodestroy')">
    <div
      ref="popper"
      v-show="visible"
      :style="{ width: width + 'px' }"
      :class="popperClass"
      class="gpzx-picker-panel time-select gpzx-popper">
      <gpzx-scrollbar noresize wrap-class="gpzx-picker-panel__content">
  ...
  export default {
    ...
    methods: {
      ...
      scrollToOption(selector = '.selected') {
        const menu = this.$refs.popper.querySelector('.gpzx-picker-panel__content');
