<template>
  <transition name="gpzx-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="gpzx-time-panel gpzx-popper"
      :class="popperClass">
      <div class="gpzx-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'gpzx-ui/src/utils/date-util';
