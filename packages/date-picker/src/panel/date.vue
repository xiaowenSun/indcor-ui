<template>
  <transition name="gpzx-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="gpzx-picker-panel gpzx-date-picker gpzx-popper"
      :class="[{
      ...
      <div class="gpzx-picker-panel__body-wrapper">
        ...
        <div class="gpzx-picker-panel__body">
          <div class="gpzx-date-picker__time-header" v-if="showTime">
            <span class="gpzx-date-picker__editor-wrap">
              <gpzx-input
            ...
            <span class="gpzx-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <gpzx-input
                ref="input"
          ...
          <div
            class="gpzx-date-picker__header"
            :class="{ 'gpzx-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            ...
            <span
              ...
              role="button"
              class="gpzx-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="gpzx-date-picker__header-label"
          ...
          <div class="gpzx-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
      ...
      <div
        class="gpzx-picker-panel__footer"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, GpzxInput, GpzxButton
    },
