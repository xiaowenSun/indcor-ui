<template>
  <div class="gpzx-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <gpzx-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="gpzx-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="gpzx-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'gpzx-ui/src/utils/date-util';
