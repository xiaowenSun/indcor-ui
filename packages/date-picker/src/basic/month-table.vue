<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="gpzx-month-table">
    <tbody>
...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'gpzx-ui/src/utils/date-util';
  import { hasClass } from 'gpzx-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'gpzx-ui/src/utils/util';
